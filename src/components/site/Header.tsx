    ...
    <header className="sticky top-0 z-50 border-b border-border/70 bg-background/85 backdrop-blur-xl">
      <div className="mx-auto flex h-18 w-full max-w-6xl items-center justify-between px-5 py-4">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <Link
            to="/contacto"
            className="rounded-full bg-ubuntu px-5 py-2.5 text-sm font-semibold text-accent-foreground transition-transform hover:-translate-y-0.5"
          >
            Pedir proposta
          </Link>
        </div>
      ...
      {open ? (
        <div className="border-t border-border bg-surface px-5 py-4 md:hidden">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-3 block rounded-full bg-ubuntu px-5 py-3 text-center text-sm font-semibold text-accent-foreground"
          >
            Falar no WhatsApp
          </a>
        </div>
